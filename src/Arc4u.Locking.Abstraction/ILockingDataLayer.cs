...
public interface ILockingDataLayer
{
    ...
    ///     <remarks>
    ///         the lock will be kept alive while the process is running. The timeout strokes, when there is no more activity,
    ...
    ///     </remarks>
    /// </returns>
    Task<Lock?> TryCreateLockAsync(string label, TimeSpan maxAge, Func<Task> cleanUpCallBack,
