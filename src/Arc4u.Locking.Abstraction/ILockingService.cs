...
public interface ILockingService
{
    ...
    /// <remarks>This value should be rather small, even if the delegate being run takes longer. During the run, the lock be be kept alive automatically</remarks>
    /// </param>
    /// <param name="toBeRun">
    ...
    /// </param>
    /// <returns>
    /// Lock, that is being refresh on the datalayer as long as it is not disposed. If no lock could be obtained, null will be returned.
    /// </returns>
    /// <remarks>Most be disposed!</remarks>
