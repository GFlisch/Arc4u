...
{
    /// <summary>
    /// The structure is a helper to:
    ///     - define a period of time and compute the remaining time before the period expire.
    ///     - Add methods to manipulate timespan.
    ///     - Callback method based on the remaining time.
    ///     - WaitOne method for timespan value greater than Int32.MaxValue.
    /// </summary>
