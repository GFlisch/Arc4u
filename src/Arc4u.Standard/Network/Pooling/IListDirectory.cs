...
{
    /// <summary>
    ///     Returns a collection of full-qualified path names which represents the files in the specified
    ///     <paramref name="path" />.
    /// </summary>
    public ICollection<string> ListFiles(string path);

    /// <summary>
    ///     Returns a collection of full-qualified path names which represents the sub-directories in the specified
    ///     <paramref name="path" />.
    /// </summary>
