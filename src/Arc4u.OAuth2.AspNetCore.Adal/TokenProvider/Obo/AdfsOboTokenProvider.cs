...
public class AdfsOboTokenProvider : AdalOboTokenProvider
{
    ...
    public AdfsOboTokenProvider(IUserObjectIdentifier userCacheKeyIdentifier, ILogger<AdfsOboTokenProvider> logger, IContainerResolve container, IApplicationContext applicationContext) : base(userCacheKeyIdentifier, logger, container, applicationContext) { }
