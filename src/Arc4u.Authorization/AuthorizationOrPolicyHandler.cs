...
/// <summary>
/// Handles <see cref="AuthorizationOrRequirement"/> by verifying that the current principal
/// possesses at least <b>one</b> of the required scoped permissions (OR logic).
/// </summary>
/// <remarks>
