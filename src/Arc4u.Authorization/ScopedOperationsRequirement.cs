...
/// <summary>
/// An authorization requirement that succeeds only if <b>all</b> of the specified permissions are present
/// on the current principal (AND logic).
/// </summary>
/// <remarks>
...
public class ScopedOperationsRequirement : IAuthorizationRequirement
{
    ...
    public ScopedOperationsRequirement(params int[] permissions)
    {
    ...
    public ScopedOperationsRequirement(string scope, params int[] permissions)
    {
    ...
    public ScopedOperationsRequirement(params (string, int)[] permissions)
    {
        Permissions = permissions;
    }

    /// <summary>
    /// Gets the set of (scope, permission) pairs that must <b>all</b> be satisfied.
    /// </summary>
