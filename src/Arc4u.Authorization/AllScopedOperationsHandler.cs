...
/// <summary>
/// Handles <see cref="AllScopedOperationsRequirement"/> by verifying that the current principal
/// is granted <b>all</b> of the required scoped operations (AND logic).
/// </summary>
/// <remarks>
...
public sealed class AllScopedOperationsHandler(IApplicationContext applicationContext)
    : AuthorizationHandler<AllScopedOperationsRequirement>
{
    /// <inheritdoc />
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AllScopedOperationsRequirement requirement)
    {
