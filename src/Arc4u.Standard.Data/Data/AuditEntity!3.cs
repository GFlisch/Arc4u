    ...
    : IdEntity<TId>
{
    ...
    /// <ignore/>
    protected TAuditedBy _auditedBy = default!;
    ...
    /// <ignore/>
    protected TAuditedOn _auditedOn = default!;
    ...
    {
        return string.Format(CultureInfo.InvariantCulture, "{0}, AuditedBy = {1}, AuditedOn = {2}"
            , base.ToString()
            , AuditedBy
            , AuditedOn);
    }
