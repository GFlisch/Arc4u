    ...
    , ICreateAuditEntity<TCreatedBy, TCreatedOn>
{
    ...
    /// <ignore/>
    protected TCreatedBy _createdBy = default!;
    ...
    /// <ignore/>
    protected TCreatedOn _createdOn = default!;
    ...
    {
        return string.Format(CultureInfo.InvariantCulture, "{0}, CreatedBy = {1}, CreatedOn = {2}"
            , base.ToString()
            , CreatedBy
            , CreatedOn);
    }
